...
int main(int argc, char** argv)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        demoCube->UpdateFixedFrameRate(true, framesMs);
        //---------------------------------------------------------Affichage-------------------------------------------------------------------------
...
void ChooseWitchApplicationIsWanted(GLFWwindow* window)
{
    switch (APPLICATION_WANTED)
    {
    case 0:
    {
        demoCube = new DemoCube(window, camera, false, Vector3D(0, -10, 0), Vector3D(4, -1, 0), Vector3D(0.1, 0.25, 0.15), Vector3D(0, 2, 0));//cubePosition, cubeVelocity, localPointOnCube, force.
        break;
    }
    case 1:
    {
        //true permet à la camera de suivre le cube lors de son evolution
        demoCube = new DemoCube(window, camera, true, Vector3D(0, -10, 0), Vector3D(4, -1, 0), Vector3D(0.5, 0, 0.5), Vector3D(0, 3, 0));
        break;
    }
    case 2:
    {
        demoCube = new DemoCube(window, camera, false, Vector3D(0, -10, 0), Vector3D(4, 1, -1), Vector3D(0.5, 0.5, 0), Vector3D(0, 0,3));
        break;
    }
    case 3:
    {
        demoCube = new DemoCube(window, camera, false, Vector3D(0, -10, 0), Vector3D(1, 0, 0), Vector3D(0.5, 0.5, 0), Vector3D(3, 0, 0));
        break;
    }
    case 4:
    {
        demoCube = new DemoCube(window, camera, false, Vector3D(0, -10, 0), Vector3D(1, -1, 0), Vector3D(0, 0.5, 0.5), Vector3D(0, 3, 0));
        break;
    }
    default:
    {
        demoCube = new DemoCube(window, camera, false, Vector3D(0, -10, 0), Vector3D(1, 0, 0), Vector3D(0.5, 0, 0.5), Vector3D(0, 0, 3));
        break;
    }
    }
}
