...
void RigidBodyContactResolver::resolveContacts(RigidBodyContact* contactArray, unsigned int numContact, float duration)
{
	...
	while (m_iteration < numContact) {
		RigidBodyContact* contactToResolve = nullptr;
